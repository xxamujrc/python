...
button_1 = customtkinter.CTkButton(
    master=frame_1, corner_radius=8, command=button_function)  # realT())
button_1.pack(pady=y_padding, padx=10)

slider_1 = customtkinter.CTkSlider(
    master=frame_1, command=slider_function, from_=0, to=1)
...
checkbox_1 = customtkinter.CTkCheckBox(
    master=frame_1, command=check_box_function)
